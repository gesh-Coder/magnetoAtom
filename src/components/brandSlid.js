...
import {Link} from 'react-router-dom';
 ...
 class brandSlid extends Component {
                    ...
                    <div id="carouselmainslider" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <Link to="/BrandFiche"><img className="d-block w-100" src={slide_01} alt="First slide" /></Link>
                            </div>
                            <div className="carousel-item">
                                <Link to="/BrandFiche"><img className="d-block w-100" src={slide_02} alt="Second slide" /></Link>
                            </div>
                            <div className="carousel-item active">
                                <Link to="/BrandFiche"><img className="d-block w-100" src={slide_01} alt="First slide" /></Link>
                            </div>
